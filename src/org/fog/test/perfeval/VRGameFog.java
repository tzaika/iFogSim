...
*/
                moduleMapping.addModuleToDeviceIfNotPresent("connector", "cloud"); // fixing all instances of the Connector module to the Cloud
                moduleMapping.addModuleToDeviceIfNotPresent("concentration_calculator", "cloud"); // fixing all instances of the Concentration Calculator module to the Cloud
                for (FogDevice device : fogDevices) {
                    if (device.getName().startsWith("m")) {
                        ...
                        moduleMapping.addModuleToDeviceIfNotPresent("client", device.getName());  // fixing all instances of the Client module to the Smartphones
                    }
                }
            } else {
                // if the mode of deployment is cloud-based
