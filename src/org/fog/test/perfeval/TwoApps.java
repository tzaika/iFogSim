...
public class TwoApps {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            moduleMapping_0.addModuleToDeviceIfNotPresent("connector", "cloud"); // fixing all instances of the Connector module to the Cloud
            moduleMapping_0.addModuleToDeviceIfNotPresent("concentration_calculator", "cloud"); // fixing all instances of the Concentration Calculator module to the Cloud
            moduleMapping_1.addModuleToDeviceIfNotPresent("connector_1", "cloud"); // fixing all instances of the Connector module to the Cloud
            moduleMapping_1.addModuleToDeviceIfNotPresent("concentration_calculator_1", "cloud"); // fixing all instances of the Concentration Calculator module to the Cloud
            for (FogDevice device : fogDevices) {
                if (device.getName().startsWith("m")) {
                    moduleMapping_0.addModuleToDeviceIfNotPresent("client", device.getName());  // fixing all instances of the Client module to the Smartphones
                    moduleMapping_1.addModuleToDeviceIfNotPresent("client_1", device.getName());  // fixing all instances of the Client module to the Smartphones
                }
            }
